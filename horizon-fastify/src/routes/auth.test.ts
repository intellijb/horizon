...
describe("Auth Routes Integration Tests", () => {
  ...
  describe("POST /auth/register", () => {
    ...
    it("should return 400 for duplicate email", async () => {
      ...
      const body = response.json();
      assertions.expectErrorResponse(body, 400, "already exists");
    });
  ...
  describe("POST /auth/login", () => {
    ...
    it("should return 401 for wrong password", async () => {
      ...
      const body = response.json();
      assertions.expectErrorResponse(body, 401, "Invalid");
    });
    ...
    it("should return 401 for non-existent user", async () => {
      ...
      expect(response.statusCode).toBe(401);
      const body = response.json();
      assertions.expectErrorResponse(body, 401);
    });
    ...
    it("should enforce rate limiting after failed attempts", async () => {
      ...
      const body = response.json();
      assertions.expectErrorResponse(body, 429, "Too many");
    });
  });
  ...
  describe("GET /auth/me", () => {
    ...
    it("should return 401 with invalid token", async () => {
      ...
      expect(response.statusCode).toBe(401);
      const body = response.json();
      assertions.expectErrorResponse(body, 401, "Invalid token");
    });
